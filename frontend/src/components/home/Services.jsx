      ...
      <section className="bg-gradient-to-b from-slate-950 via-slate-900 to-black py-28">
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <motion.div
            ...
            transition={{ duration: .8 }}
            viewport={{ once: true }}
            className="mt-16 overflow-hidden rounded-3xl shadow-2xl"
          >
          ...
          <div className="text-center mt-20">
            ...
            <p className="text-gray-300 text-xl leading-9 max-w-5xl mx-auto mt-8">
  ...
  <div className="grid lg:grid-cols-2 items-center">
    ...
    <div className="p-12">
      ...
      <h2 className="text-5xl font-bold text-white leading-tight">
        Why Choose
        <span className="text-cyan-400"> diTrinity Cloud?</span>
      </h2>
      ...
      <div className="grid grid-cols-2 gap-5 mt-10">
        ...
        <div className="bg-slate-800 rounded-2xl p-6 hover:bg-cyan-500 duration-300 hover:text-black cursor-pointer">
    ...
    <img
      src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1400"
      className="h-full w-full object-cover hover:scale-105 duration-700"
    />
      ...
      <section className="bg-slate-950 py-24">
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-r from-cyan-600 to-blue-700 rounded-3xl p-14 text-center shadow-2xl"
          >
            ...
            <p className="text-xl text-gray-100 mt-8 max-w-3xl mx-auto leading-9">
              Whether you're planning a cloud migration, modernizing your
              infrastructure, or optimizing existing workloads, diTrinity
              Technologies delivers secure, scalable and future-ready cloud
              solutions.
            </p>
